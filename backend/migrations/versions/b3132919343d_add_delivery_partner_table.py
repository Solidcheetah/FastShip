...
Revision ID: b3132919343d
Revises: 6f2b8a4d91e0
Create Date: 2026-06-13 03:01:08.193382
...
revision: str = 'b3132919343d'
down_revision: Union[str, Sequence[str], None] = '6f2b8a4d91e0'
...
def upgrade() -> None:
    ...
    sa.Column('servicable_zip_code', sa.ARRAY(sa.INTEGER()), nullable=True),
    ...
    op.create_foreign_key('fk_shipment_delivery_partner_id', 'shipment', 'delivery_partner', ['delivery_partner_id'], ['id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_shipment_delivery_partner_id', 'shipment', type_='foreignkey')

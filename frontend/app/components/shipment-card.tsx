        ...
        <div className="rounded-xl border bg-card text-card-foreground">
            ...
            <div className="grid gap-4 p-6 pt-0">
                <div className="flex items-center space-x-4 rounded-xl p-[15px] bg-gray-100 relative">
                    <div className="absolute left-[80px] top-[35px] bottom-[35px] w-0.5 bg-gray-300" />
                    <div data-line className={`absolute left-[80px] top-[35px] bottom-[35px] w-0.5 ${statusColor.bgColor}`} />
                ...
                <Sheet>
                    ...
                    <SheetContent className="sm:max-w-[640px] overflow-y-auto">
                        <SheetHeader>
                            ...
                            <SheetDescription>
                                Details and timeline for this shipment.
                            </SheetDescription>
                        </SheetHeader>

...
export interface ShipmentCreate {
  /**
   * Content
   * Describes the content of the shipment
   * @maxLength 30
   */
  content: string;
  /**
  ...
  /**
   * Destination
   * Destination zipcode, if not provided random zipcode will be generated
   */
...
> extends HttpClient<SecurityDataType> {
  ...
  shipment = {
    /**
     * @description Fetch a single shipment by id. Restricted to sellers.
     *
     * @tags Shipment
     * @name GetShipment
    ...
    /**
     * @description Create a new shipment on behalf of the authenticated seller.
     *
     * @tags Shipment
     * @name SubmitShipment
    ...
    /**
     * @description Update shipment fields. Restricted to the delivery partner handling it.
     *
     * @tags Shipment
     * @name PatchShipment
    ...
    /**
     * @description Cancel a shipment. Restricted to the seller who created it.
     *
     * @tags Shipment
     * @name DeleteShipment
  ...
  partner = {
     ...
     *
     * @tags Delivery Partner
     * @name GetPartnerShipments
     * @summary Get Partner Shipments
     * @request GET:/partner/shipments
     * @secure
     */
    getPartnerShipments: (params: RequestParams = {}) =>
      this.request<ShipmentRead[], any>({
